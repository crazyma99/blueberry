...
- 品牌定制
  ...
  - 示例参考：[profiles/blueberry/project.env:9-20](file://profiles/blueberry/project.env#L9-L20)、[src/components/AppFooter/AppFooter.uvue:18-22](file://src/components/AppFooter/AppFooter.uvue#L18-L22)。
- 功能开关
...
- 主题切换
  ...
  - 示例参考：[scripts/apply-profile.sh:91-95](file://scripts/apply-profile.sh#L91-L95)、[src/pages/priceList/index.uvue:20-21](file://src/pages/priceList/index.uvue#L20-L21)。

章节来源
- [profiles/blueberry/project.env:9-20](file://profiles/blueberry/project.env#L9-L20)
- [src/components/AppFooter/AppFooter.uvue:18-22](file://src/components/AppFooter/AppFooter.uvue#L18-L22)
...
- [src/pages/priceList/index.uvue:20-21](file://src/pages/priceList/index.uvue#L20-L21)
...
- 静态资源未生效
  ...
  - 参考：[scripts/apply-profile.sh:91-95](file://scripts/apply-profile.sh#L91-L95)、[src/pages/priceList/index.uvue:20-21](file://src/pages/priceList/index.uvue#L20-L21)。
- API 请求异常
...
建议在团队内规范使用 create-profile.sh 创建新项目，遵循 templates 的字段命名与取值约定，并在 CI 中加入构建与校验步骤，确保质量与一致性。
