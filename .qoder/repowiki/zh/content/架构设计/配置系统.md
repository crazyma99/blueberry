...
## 更新摘要
**已进行的更改**
- HTTP基础URL已从测试环境'https://crazyma99.xyz'成功迁移到生产环境'https://lanmei66.cloud/'
...
**最新更新**：HTTP请求基础URL配置已成功从测试环境'https://crazyma99.xyz'迁移到生产环境'https://lanmei66.cloud/'，表明应用已完成测试阶段并准备部署。所有Profile配置文件已同步更新，超时配置保持15000ms不变。
...
- [scripts/lib/apply-profile.mjs:1-201](file://scripts/lib/apply-profile.mjs#L1-L201)
...
- Node 注入工具（apply-profile.mjs）
  ...
  - 关键行为参考：[scripts/lib/apply-profile.mjs:1-201](file://scripts/lib/apply-profile.mjs#L1-L201)。
...
- 功能开关
  ...
  - 示例参考：[scripts/lib/apply-profile.mjs:144-150](file://scripts/lib/apply-profile.mjs#L144-L150)、[src/utils/http.uts:106-110](file://src/utils/http.uts#L106-L110)。
- 主题切换
...
- [scripts/lib/apply-profile.mjs:144-150](file://scripts/lib/apply-profile.mjs#L144-L150)
- [src/utils/http.uts:106-110](file://src/utils/http.uts#L106-L110)
...
### HTTP请求基础URL配置更新
**最新更新**：HTTP请求基础URL配置已成功从测试环境'https://crazyma99.xyz'迁移到生产环境'https://lanmei66.cloud/'。
...
- [src/utils/http.uts:34-38](file://src/utils/http.uts#L34-L38)
...
- API 请求异常
  ...
  - 参考：[scripts/lib/apply-profile.mjs:144-150](file://scripts/lib/apply-profile.mjs#L144-L150)、[src/utils/http.uts:106-110](file://src/utils/http.uts#L106-L110)。
- 新环境问题排查
  - 现象：切换到新环境后请求失败。
...
**最新改进**：HTTP请求基础URL已成功切换到新环境'https://lanmei66.cloud/'，提升了系统的稳定性和性能。应用已完成测试阶段并准备部署。建议在团队内规范使用 create-profile.sh 创建新项目，遵循 templates 的字段命名与取值约定，并在 CI 中加入构建与校验步骤，确保质量与一致性。
