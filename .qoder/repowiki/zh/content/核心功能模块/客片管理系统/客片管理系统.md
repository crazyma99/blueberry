...
**更新** 本版本新增了AI试衣功能的完整集成，包括AI试衣模板选择、用户照片上传、任务提交与结果轮询等全流程功能。
...
subgraph "工具与服务层"
I["utils/api.uts<br/>客片接口/AI试衣接口"]
J["utils/http.uts<br/>HTTP请求封装"]
K["utils/auth.uts<br/>认证与用户信息"]
L["utils/loginFlow.uts<br/>登录流程"]
M["utils/format.uts<br/>数字格式化"]
N["utils/imageLoader.uts<br/>图片预加载"]
O["utils/config.uts<br/>环境配置"]
end
A --> D
A --> E
A --> F
